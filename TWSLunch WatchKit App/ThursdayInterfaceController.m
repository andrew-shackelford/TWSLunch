...
#import "ThursdayInterfaceController.h"
#import "HTMLReader.h"
#import "StoreData.h"



@interface ThursdayInterfaceController()

@end


@implementation ThursdayInterfaceController
...
- (void)loadData {
    ...
    NSArray *today = [data objectAtIndex:3];
    NSString *title = nil;
