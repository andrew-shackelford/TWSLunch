...
#import "FridayInterfaceController.h"
#import "HTMLReader.h"
#import "StoreData.h"


@interface FridayInterfaceController()

@end


@implementation FridayInterfaceController
...
- (void)loadData {
    ...
    NSArray *today = [data objectAtIndex:4];
    NSString *title = nil;
