...
#import "TuesdayInterfaceController.h"
#import "HTMLReader.h"
#import "StoreData.h"


@interface TuesdayInterfaceController()

@end


@implementation TuesdayInterfaceController
...
- (void)loadData {
    ...
    NSArray *today = [data objectAtIndex:1];
    NSString *title = nil;
